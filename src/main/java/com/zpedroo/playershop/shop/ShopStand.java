...
public class ShopStand {
    ...
    private void create() {
        ...
        armorStand = (ArmorStand) shop.getLocation().getWorld().spawnEntity(shop.getLocation().clone().add(0.5D, -1.25D, 0.5D), EntityType.ARMOR_STAND);
        ...
        // after all, teleport without visual bugs...
        armorStand.teleport(shop.getLocation().clone().add(0.5D, -0.275D, 0.5D));
    }
